...
useHead({
  ...
  meta: [
    { name: 'description', content: 'I manage a Kubernetes cluster with four nodes using Raspberry Pi hardware. It serves as a platform for my personal projects and facilitates my exploration of cloud-native technologies. Below are the services I employ to oversee and manage my Kubernetes setup.' },
    { name: 'og:type', content: 'website' },
    { name: 'og:url', content: 'https://www.oglimmer.com/k8s' },
    { name: 'og:title', content: 'kubernetes @ oglimmer.com' },
    { name: 'og:description', content: 'I manage a Kubernetes cluster with four nodes using Raspberry Pi hardware. It serves as a platform for my personal projects and facilitates my exploration of cloud-native technologies. Below are the services I employ to oversee and manage my Kubernetes setup.' },
...
const data = [
  ...
  },
  {
      ...
      linkData: [
        ["https://grafana.oglimmer.com/", "Dashboard"],
  ...
  },
  {
      ...
      linkData: [
        ["https://git-deploy-control.oglimmer.com/", "Dashboard"]
      ],
      ...
      <div class="row py-5 align-items-center">
        <div class="col-lg-8">
          ...
          <p class="h5 aa mb-4 pb-3 text-white-50">
            I manage a Kubernetes cluster with four nodes using Raspberry Pi hardware.
            It serves as a platform for my personal projects and facilitates my exploration of cloud-native technologies.
            Below are the services I employ to oversee and manage my Kubernetes setup.
          </p>
        </div>
